...
var _ = Describe("K8sIstioTest", func() {
	...
	var (
		...
		prerelease     = "-beta.1"
		istioctlParams = // ""
		" --set values.pilot.image=docker.io/jrajahalme/istio_pilot:1.8.2-beta.1" +
			" --set values.global.proxy.image=docker.io/jrajahalme/istio_proxy:1.8.2-beta.1" +
			" --set values.global.proxy_init.image=docker.io/jrajahalme/istio_proxy:1.8.2-beta.1" +
			""
